...
__interrupt void TA0CCR0_isr(void) {
  ...
  switch (P1IN & 0b00110000) {
    case 0b00110000:
      TA0CCR0 = 15000;  // Period 1.2s
      TA0CCR1 = 7500;   // Pulse 0.6s, D=50%
      break;
    case 0b00100000:
      TA0CCR0 = 22500;  // Period 1.8s
      TA0CCR1 = 15000;  // Pulse 1.2s, D=66%
      break;
    case 0b00010000:
      TA0CCR0 = 30000;  // Period 2.4s
      TA0CCR1 = 22500;  // Pulse 1.8s, D=75%
      break;
    case 0b00000000:
      TA0CCR0 = 37500;  // Period 3s
      TA0CCR1 = 30000;  // Pulse 2.4s, D=80%
      break;
  }
}